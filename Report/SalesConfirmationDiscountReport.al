report 50116 "TBMS Sales Conf Dsicount"
{
    RDLCLayout = 'Reports/StandardSalesOrderConfDiscount.rdlc';
    WordLayout = 'Reports/StandardSalesOrderConfDiscount.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                begin
                    if TBMSIsFieldConfidentalLine = false
                   then begin
                        CurrReport.Skip();
                    end;
